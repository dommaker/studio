 ...
 */
export function queryCompanyKnowledge(companyId, query, maxResults = 5) {
 ...
 * 查询技能（专门搜索 skills/ 目录）
 */
export function queryCompanySkills(companyId, taskDescription, maxResults = 3) {
 ...
 */
export function queryCompanyPitfalls(companyId, taskDescription, maxResults = 3) {
    const results = queryCompanyKnowledge(companyId, taskDescription, 20);
    return results
