 ...
 * 决策类立场
 */
export declare const DECISION_STANCES: readonly ["critic", "supporter", "decider"];
/**
 * 执行类立场
 */
export declare const EXECUTION_STANCES: readonly ["planner", "executor", "tester"];
/**
 * 专业类立场
 */
export declare const PROFESSIONAL_STANCES: readonly ["architect", "security", "performance", "auditor", "designer", "product"];
/**
 * 所有立场 ID
 */
export type StanceId = typeof DECISION_STANCES[number] | typeof EXECUTION_STANCES[number] | typeof PROFESSIONAL_STANCES[number];
/**
 * 立场继承优先级
 *
 ...
 * 立场审核类型
 */
export type StanceReviewType = 'single' | 'parallel' | 'sequential';
/**
 * 立场审核配置
 */
 ...
 * 系统默认立场
 */
export declare const DEFAULT_STANCE: StanceId;
/**
 * 立场 prompt 模板变量
 */
