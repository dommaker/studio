 ...
 */
export declare function parseAttestations(metadata: unknown): WuAttestations | undefined;
/** 追加/覆盖一层证据（返回新对象，不改原值；每层只留最新一条） */
export declare function withAttestation(existing: WuAttestations | undefined, level: 'l1' | 'l2' | 'l3', entry: AttestationEntry): WuAttestations;
/**
 ...
 */
export declare function deriveDisplayState(input: {
    status: string;
    metadata?: unknown;
}): DerivedWuState;
