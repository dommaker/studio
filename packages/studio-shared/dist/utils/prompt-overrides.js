...
export function resolvePromptOverridesDir() {
 ...
 */
export function readPromptOverride(templateId) {
    if (!templateId || /[/\\]/.test(templateId) || templateId.includes('..'))
        return null;
    try {
 ...
 */
export function renderWithOverride(templateId, fallback, vars) {
