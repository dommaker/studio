 ...
 * 加载 Agent Studio 配置
 */
export function loadAgentStudioConfig() {
    return {
        // 路径配置
        ...
        // Agent 配置
        defaultAgentType: process.env.DEFAULT_AGENT_TYPE || DEFAULT_CONFIG.defaultAgentType,
        // API Keys
 ...
 * 获取 API Key
 */
export function getApiKey(keyIndex = 1) {
    return {
