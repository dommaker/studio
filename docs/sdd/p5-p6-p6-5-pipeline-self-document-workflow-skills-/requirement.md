...
- ~/.studio/skills/review/forensic-review/SKILL.md
- ~/.studio/skills/review/multi-stance-review/SKILL.md
## Code Changes Detected (L4)

**Affected files**: apps/api/src/modules/goals/pipeline-utils.ts, apps/api/src/modules/goals/scheduler-dispatch.ts, apps/api/src/modules/goals/scheduler-prompt.ts, packages/studio-skill/src/__tests__/loader.test.ts, packages/studio-skill/src/index.ts, packages/studio-skill/src/loader.ts

**Diff summary**:
```diff
diff --git a/apps/api/src/modules/agents/agent-context.ts b/apps/api/src/modules/agents/agent-context.ts
index 1efb2c3d..c95eb313 100644
--- a/apps/api/src/modules/agents/agent-context.ts
+++ b/apps/api/src/modules/agents/agent-context.ts
@@ -4,14 +4,12 @@
...
diff --git a/apps/api/src/modules/agents/review-agent.service.ts b/apps/api/src/modules/agents/review-agent.service.ts
index e22ad9fe..5f5bec45 100644
--- a/apps/api/src/modules/agents/review-agent.service.ts
+++ b/apps/api/src/modules/agents/review-agent.service.ts
...
+      const reviewerSkills = skillLoader.load({ agentType: 'reviewer' });
       const skillSection = reviewerSkills.length > 0
         ? '\n' + skillLoader.formatForPrompt(reviewerSkills) + '\n'
         : '';
diff --git a/apps/api/src/modules/channels/analyst-prompt.ts b/apps/api/src/modules/channels/analyst-prompt.ts
index 61da56b2..6bac8170 100644
--- a/apps/api/src/modules/channels/analyst-prompt.ts
+++ b/apps/api/src/modules/channels/analyst-prompt.ts
...
+  const analystSkills = skillLoader.load({ agentType: 'analyst' });
   const skillSection = analystSkills.length > 0
     ...
     : '';
diff --git a/apps/api/src/modules/channels/conversation-handler.ts b/apps/api/src/modules/channels/conversation-handler.ts
index 47702eb8..a18234ff 100644
--- a/apps/api/src/modules/channels/conversation-handler.ts
+++ b/apps/api/src/modules/channels/conversation-handler.ts
...
> Auto-detected by SddFreshnessService. Layer: requirement. Review and integrate manually.
