 ...
 *
 * 生产 web 与 API 同源（studio.dommaker.cn），本不需要 CORS；白名单覆盖：
 * - env CORS_ORIGINS 显式列表（逗号分隔，缺省 dommaker.cn 两域 + studio 子域）
...
const DEFAULT_ORIGINS = 'https://dommaker.cn,https://www.dommaker.cn,https://studio.dommaker.cn';
