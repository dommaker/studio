      ...
      >
        ...
        <div className="space-y-2 mb-4">
          <button
            ...
            className="w-full px-4 py-2.5 bg-white/10 border border-gray-600 rounded-lg text-white text-sm hover:bg-white/20 transition-colors flex items-center justify-center gap-2"
          >
