      ...
      >
        ...
        <div className="space-y-2 mb-4">
          <button
            ...
            className="w-full px-4 py-2.5 u-surface-2 border u-border-2 rounded-lg u-text text-sm u-hover-bg transition-colors flex items-center justify-center gap-2"
          >
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-xs u-text-2">或</span>
          <div className="flex-1 h-px" style={{ background: "var(--border-default)" }}></div>
        </div>
        ...
        <div className="mt-3 text-center">
          <a
            ...
            className="text-xs u-text-2 u-hover-text transition-colors"
          >
            忘记密码？
          </a>
        </div>
