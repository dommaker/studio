...
if $CHECK_ALL; then
  PKGS="apps/api,apps/web,packages/studio-shared,packages/studio-agent,packages/studio-prisma,packages/studio-skill,packages/studio-spec,packages/studio-audit,packages/studio-capability,packages/studio-notification"
else
